<template>
  <div class="mainContainer">
     ...
     <section class="rightContainer">
          <NavHeader>
            <slot name="modelName">组织-日/周视图</slot>
          </NavHeader>
          <section class="orgLoginDayContainer" v-loading="listLoading">
           ...
           <div class="orgLoginDayChartContainer">
...
<script>
import './../../assets/scss/orgLoginDay.scss';
      ...
      axios.get("/api/analysis/register",{
        params:param
          ...
          if(res.status == 10000){
                ...
                this.chartDayData.chartTitle = '组织登录-日视图';
                ...
                this.chartWeekData.chartTitle = '组织-周视图';
